    ...
    <div className="min-h-screen bg-zinc-950 flex items-center justify-center p-4">
      <div className="w-full max-w-md space-y-8">
        <div className="text-center">
          ...
          <p className="text-zinc-400 mt-2">Create your organization</p>
        </div>
        <form onSubmit={handleSubmit} className="space-y-4 bg-zinc-900 p-6 rounded-xl border border-zinc-800">
          <h2 className="text-xl font-semibold text-zinc-100">Register</h2>
          {error && (
          ...
          <div className="space-y-2">
            ...
            <input
              ...
              required
            />
            <p className="text-xs text-zinc-500">Slug: {tenantSlug || '...'}</p>
          </div>
          <div className="space-y-2">
          ...
          <div className="space-y-2">
            ...
            <input
              ...
              placeholder="••••••••••••"
              className={`w-full bg-zinc-800 border rounded-lg px-3 py-2 text-zinc-100 placeholder:text-zinc-500 focus:outline-none focus:ring-2 focus:ring-blue-500 ${
                confirmPassword && password !== confirmPassword ? 'border-red-500' : 'border-zinc-700'
              }`}
              required
            />
          </div>
          <button
            type="submit"
            disabled={isLoading || password !== confirmPassword || password.length < 10}
